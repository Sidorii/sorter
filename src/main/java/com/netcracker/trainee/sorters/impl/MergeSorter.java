...
public class MergeSorter extends Sorter {
     ...
     * (Proceeding sorting input array by merge sorting method (recursive sorting method when array divides on a parts
     * until parts does not become 1 element length. As new created subarrays is 1 element length it makes them
     * auto-sorted by default and then this subarrays merging between each other while does not become the input
     * sorted array again).
     *
     * {@inheritDoc}
